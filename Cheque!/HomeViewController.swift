...
//        self.navigationController?.navigationBar.frame = CGRect(x: 0, y: 0, width: bounds.width, height: bounds.height + height)
    ...
    override func viewDidLoad() {
        ...
        let event1 = Event(name: "WICC G-Body Meeting", eventLocation: "Gates G01", day: 2, month: 3, year: 2019)
        let event2 = Event(name: "AppDev: iOS Workshop", eventLocation: "Phillips 223", day: 3, month: 12, year: 2018)
        let event3 = Event(name: "CS 1110 Review Session", eventLocation: "Olin Library 100", day: 4, month: 12, year: 2018)
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: eventCellReuseIdentifier, for: indexPath) as! UpcomingEventsCollectionViewCell
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: eventCellReuseIdentifier, for: indexPath) as! UpcomingEventsCell
